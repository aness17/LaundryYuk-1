    ...
    <section id="topbar" class="d-none d-lg-block">
        <div class="container d-flex">
            <div class="contact-info mr-auto">
                <ul>
                    <li><i class="icofont-envelope"></i><a>laundryyuk@gmail.com</a></li>
                    <li><i class="icofont-phone"></i> +62 822 8590 7789</li>
        ...
        <div class="container d-flex">
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li><a class="btn btn-warning badge" href=<?= base_url('index.php/login/') ?>>Login</a></li>
