                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <a href="<?= base_url('index.php/agen/addpemesanan') ?>" type="button" class="btn btn-success text-white btn-sm">
                                Tambah
                            </a>
                        </div>
                        <div class="card-body">
                                        ...
                                        foreach ($pemesanan->result_array() as $users) : ?>
                                            <tr style="text-align: center;">
                                                ...
                                                <td class="text-center">
                                                    <a href="<?= base_url('index.php/agen/editpesan/' . $users['id_transaksi']) ?>" type="button" class="fas fa-edit btn btn-warning">
                                                    </a>
